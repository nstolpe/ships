...
// var source = PIXI.Sprite.fromImage( "assets/images/sand.png" );
	...
	return {
		...
		shader: {
			...
			fragment:
				...
				uniform float uTime;
				void main(void) {
					float fragTime = uTime * 0.05;
					// vec2 uv = fragCoord.xy / uDimensions.xy;
					vec2 uv = vTextureCoord;//* filterArea.xy;
